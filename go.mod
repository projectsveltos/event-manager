...
require (
	...
	github.com/projectsveltos/libsveltos v0.6.1-0.20230304225209-0fd0a8d19b92
	github.com/projectsveltos/sveltos-manager v0.6.1-0.20230307195300-405dd4d603c2
