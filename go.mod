...
require (
	...
	github.com/projectsveltos/addon-controller v0.51.2-0.20250410105352-5926b04415f1
	github.com/projectsveltos/libsveltos v0.51.2-0.20250412140407-19dc5a617e53
