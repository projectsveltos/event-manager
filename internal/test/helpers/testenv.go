...
import (
	...
	"github.com/projectsveltos/event-manager/internal/test/helpers/external"
)
...
func NewTestEnvironmentConfiguration(crdDirectoryPaths []string, s *apimachineryscheme.Scheme) *TestEnvironmentConfiguration {
	...
	clusterProfileCRD := external.TestClusterProfileCRD.DeepCopy()
	return &TestEnvironmentConfiguration{
		env: &envtest.Environment{
			...
			CRDs: []*apiextensionsv1.CustomResourceDefinition{
				clusterCRD, machineCRD, clusterProfileCRD,
			},
		},
	}
}
